...
// TOYA
#include "gui/lvgl/core/lv_draw_toya.h"
...
#elif LV_USE_GPU_TOYA
    driver->draw_ctx_init = lv_draw_toya_ctx_init;
    driver->draw_ctx_deinit = lv_draw_toya_ctx_deinit;
    driver->draw_ctx_size = sizeof(lv_draw_toya_ctx_t);
#else
