...
#include "../draw/qingo/lv_draw_qingo.h"
...
#elif LV_USE_GPU_QINGO
    driver->draw_ctx_init = lv_draw_qingo_init_ctx;
    driver->draw_ctx_deinit = lv_draw_qingo_deinit_ctx;
    driver->draw_ctx_size = sizeof(lv_draw_qingo_ctx_t);
#else
